# SRS-004: Software Requirements — Thêm nút back và mock data cho Temperature Dashboard
...
|------------|---------|--------|
| (see §4 above) | SDD-004_temperaturedashback.md | VVR-004_temperaturedashback_results.md |

*Full traceability: [TM-001](../TM/TM-001_traceability.md)*

---
*Document: SRS-004 | Standard: IEC 62304 §5.2*
